...
export const en = {
  ...
  'settings.unreadable': 'Could not read your settings. What you see may not match what is in effect.',
  ...
  'info.licenses': 'Open source licenses',
  'info.contact': 'Contact',
  'info.contactHow': 'Send us an email. We reply within a few days.',
  'info.fontLatin': 'Korean and Latin font',
  'info.fontJapanese': 'Japanese font',
  'info.oflNote': 'The license below is left in its original wording. Translating it could change its effect.',
  'privacy.title': 'Privacy policy',
  'privacy.updated': 'Last updated {date}',
  'privacy.summary': 'Jamgim collects none of your information and sends it nowhere.',
  'privacy.h1': '1. What we collect',
  'privacy.b1': 'Nothing. No name, phone number, email address, device identifier, advertising identifier, location, or usage history. There is no sign-up and no login.',
  'privacy.h2': '2. Where things are stored',
  'privacy.b2': 'The service names, usernames, passwords and notes you enter are stored only on this device. Everything is encrypted before it is stored. The key is made from your PIN and the secure storage built into the device; nobody holds that key, including the developer.',
  'privacy.h3': '3. Where things are sent',
  'privacy.b3': 'Nowhere. This app does not request internet permission at all, and no server exists. There are no ads, no usage tracking, and no automatic crash reporting.',
  'privacy.h4': '4. Backup files',
  'privacy.b4': 'A backup file exists only when you create one. It is locked with the backup password you choose and cannot be opened without it. Where you keep it and who you send it to is entirely your decision; the app plays no part.',
  'privacy.h5': '5. Deletion',
  'privacy.b5': 'Removing the app removes the vault stored on the device with it. You can also erase it from inside the app. There was never a copy on the developer’s side.',
  'privacy.h6': '6. Children',
  'privacy.b6': 'This app is a personal record keeper with no age restriction. No information is collected about any user.',
