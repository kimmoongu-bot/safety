...
export const ko = {
  ...
  'settings.unreadable': '설정을 읽지 못했습니다. 화면에 보이는 값이 실제와 다를 수 있습니다.',
  ...
  // ── 담기 제안 ───────────────────────────────────────────────────────────
  'save.title': '담기',
  'save.asking': '{app}에 방금 넣은 것을 잠김에 담을까요?',
  'save.passwordHidden': '이 앱은 비밀번호를 알려 주지 않습니다. 비밀번호는 직접 넣어 주세요.',
  'save.askingUnknown': '방금 넣은 것을 잠김에 담을까요?',
  'save.nothing': '담을 것을 찾지 못했습니다.',
  'save.keep': '담기',
  'save.dontKeep': '담지 않기',
  'save.check': '아래 내용을 보고 고칠 것이 있으면 고쳐 주세요.',
  ...
  'info.title': '정보',
  'info.version': '판 {version}',
  'info.privacy': '개인정보 처리방침',
  'info.licenses': '오픈 소스 라이선스',
  'info.contact': '문의',
  'info.contactHow': '메일로 보내 주세요. 며칠 안에 답을 드립니다.',
  'info.fontLatin': '한글·영문 글꼴',
  'info.fontJapanese': '일본어 글꼴',
  'info.oflNote': '아래 허락서는 원문 그대로 둡니다. 옮기면 효력이 달라질 수 있습니다.',
  'privacy.title': '개인정보 처리방침',
  'privacy.updated': '마지막 수정 {date}',
  'privacy.summary': '잠김은 사용자의 어떤 정보도 모으지 않고, 어디로도 보내지 않습니다.',
  'privacy.h1': '1. 모으는 정보',
  'privacy.b1': '없습니다. 이름, 전화번호, 메일 주소, 기기 번호, 광고 번호, 위치, 사용 기록 — 어느 것도 모으지 않습니다. 회원가입도 로그인도 없습니다.',
  'privacy.h2': '2. 저장되는 곳',
  'privacy.b2': '넣으신 서비스 이름·아이디·비밀번호·메모는 이 기기 안에만 저장됩니다. 저장될 때 모두 암호로 잠깁니다. 잠그는 열쇠는 PIN(핀)과 기기의 보안 저장소에서 만들어지며, 만든 사람을 포함해 누구도 그 열쇠를 가지고 있지 않습니다.',
  'privacy.h3': '3. 보내는 곳',
  'privacy.b3': '없습니다. 이 앱은 인터넷 권한을 아예 요청하지 않고, 서버가 존재하지 않습니다. 광고도, 사용 기록을 재는 도구도, 오류 자동 신고도 넣지 않았습니다.',
  'privacy.h4': '4. 백업 파일',
  'privacy.b4': '직접 만드실 때에만 생깁니다. 파일은 정하신 백업 비밀번호로 잠겨 있어 그 비밀번호를 모르면 열 수 없습니다. 어디에 두고 누구에게 보낼지는 전적으로 사용자가 정하며, 앱은 관여하지 않습니다.',
  'privacy.h5': '5. 지우기',
  'privacy.b5': '앱을 지우면 기기에 저장된 금고 내용도 함께 사라집니다. 앱 안의 "금고 초기화"로도 지울 수 있습니다. 만든 사람 쪽에 남는 사본은 애초에 없습니다.',
  'privacy.h6': '6. 어린이',
  'privacy.b6': '이 앱은 개인 기록 도구이며 나이 제한을 두지 않습니다. 어떤 이용자에 대해서도 정보를 모으지 않습니다.',
} satisfies Catalog;
