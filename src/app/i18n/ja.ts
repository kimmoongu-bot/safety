...
export const ja = {
  ...
  'setup.lastWarnWithBiometric': ({ how }) =>
    `${how}でも開けるようにしました。暗証番号・復旧コード・バックアップファイルとそのパスワードがすべてないと、金庫は開けません。`,
  'setup.lastWarn':
    '暗証番号・復旧コード・バックアップファイルとそのパスワードがすべてないと、金庫は開けません。',
  ...
  // ── 保存の提案 ──────────────────────────────────────────────────────────
  'save.title': '保存',
  'save.asking': '{app} にいま入れたものをチャムギムに保存しますか。',
  'save.passwordHidden': 'このアプリはパスワードを渡してくれません。パスワードはご自分で入れてください。',
  'save.askingUnknown': 'いま入れたものをチャムギムに保存しますか。',
  'save.nothing': '保存するものが見つかりませんでした。',
  'save.keep': '保存する',
  'save.dontKeep': '保存しない',
  'save.check': '下の内容を見て、直すところがあれば直してください。',
  ...
  'settings.wipeExplain':
    '暗証番号・指紋・復旧コード・バックアップファイルとそのパスワードがすべてないと、金庫は開けません。そのときは金庫を消して始め直せますが、入れておいた内容は戻りません。',
  ...
  'info.title': '情報',
  'info.version': 'バージョン {version}',
  'info.privacy': 'プライバシーポリシー',
  'info.licenses': 'オープンソースライセンス',
  'info.contact': 'お問い合わせ',
  'info.contactHow': 'メールでお送りください。数日以内にお返事します。',
  'info.fontLatin': '韓国語・英字の書体',
  'info.fontJapanese': '日本語の書体',
  'info.oflNote': '下のライセンスは原文のままにしています。訳すと効力が変わることがあります。',
  'privacy.title': 'プライバシーポリシー',
  'privacy.updated': '最終更新 {date}',
  'privacy.summary': 'ジャムギムは利用者のどんな情報も集めず、どこにも送りません。',
  'privacy.h1': '1. 集める情報',
  'privacy.b1': 'ありません。名前、電話番号、メールアドレス、端末の番号、広告の番号、位置、利用履歴 — どれも集めません。会員登録もログインもありません。',
  'privacy.h2': '2. 保存される場所',
  'privacy.b2': '入力されたサービス名・ID・パスワード・メモは、この端末の中だけに保存されます。保存されるときにすべて暗号で閉じられます。鍵は暗証番号と端末の安全な保管庫から作られ、作った者を含め誰もその鍵を持っていません。',
  'privacy.h3': '3. 送る先',
  'privacy.b3': 'ありません。このアプリはインターネットの権限をそもそも求めず、サーバーも存在しません。広告も、利用状況をはかる仕組みも、不具合の自動報告も入れていません。',
  'privacy.h4': '4. バックアップファイル',
  'privacy.b4': 'ご自身で作ったときだけできます。決めたバックアップ用のパスワードで閉じられており、それを知らないと開けません。どこに置き誰に送るかはすべて利用者が決めることで、アプリは関わりません。',
  'privacy.h5': '5. 消すこと',
  'privacy.b5': 'アプリを消せば端末の金庫の中身も一緒に消えます。アプリの中の「金庫を初期化」でも消せます。作った者の側に残る控えは初めからありません。',
  'privacy.h6': '6. お子さまについて',
  'privacy.b6': 'このアプリは個人の記録の道具で、年齢の制限はありません。どの利用者についても情報を集めません。',
