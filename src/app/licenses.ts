 ...
 * 문의받을 주소.
 *
 * **앱 전용 주소다.** 개인 주소를 쓰지 않는다 — 이 주소는 스토어 목록과
 * 개인정보처리방침에 공개로 실리고, 수집 프로그램에도 잡힌다.
 *
 * 여기를 고치면 `docs/개인정보처리방침.md` 7항도 같이 고쳐야 한다. 두 곳에 적힌
 * 주소가 다르면 스토어 심사에서 걸린다. `tests/licenses.test.ts` 가 둘이 같은지
 * 본다.
 *
 * 비어 있으면 화면에서 문의 줄을 아예 감춘다 — 눌러도 아무 일 안 나는 단추를
 * 보여 주는 것이 아무것도 없는 것보다 나쁘다.
 */
export const CONTACT_EMAIL = 'jamgim.app@gmail.com';
