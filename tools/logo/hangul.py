...
def jam(p):
    ...
    p.bar(0.04, 0.09, 0.60, 0.09)
    p.bar(0.32, 0.11, 0.05, 0.52)
    p.bar(0.32, 0.11, 0.57, 0.52)
    # ㅏ — 세로획은 ㅈ 보다 위아래로 길다
    p.bar(0.81, 0.03, 0.81, 0.56)
    p.bar(0.66, 0.30, 0.81, 0.30)
    mieum(p)
